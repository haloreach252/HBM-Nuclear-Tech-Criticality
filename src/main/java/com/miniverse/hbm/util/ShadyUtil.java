...
import com.miniverse.hbm.main.ModEventHandler;
...
public class ShadyUtil {
    ...
    public static String getHash(String inp) {
        try {
            ...
            // In case SHA-256 is not supported (unlikely), return empty string.
        }
        return "";
    }
