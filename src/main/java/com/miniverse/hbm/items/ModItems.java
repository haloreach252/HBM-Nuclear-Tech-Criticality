...
public class ModItems {
    ...
    public static final RegistryObject<Item> PELLET_RTG_RADIUM = registerWithCategory("pellet_rtg_radium", () -> new ItemRTGPellet(3, new Item.Properties().stacksTo(1)).setDecays(DepletedRTGMaterial.LEAD, (
    long).

    getLifespan(16.0f,HalfLifeType.LONG, false).5,ItemCategory.CONTROL);
    public static final RegistryObject<Item> PELLET_RTG_WEAK = registerWithCategory("pellet_rtg_weak", () -> new ItemRTGPellet(5, new Item.Properties().stacksTo(1)).setDecays(DepletedRTGMaterial.LEAD, (
    long).

    getLifespan(1.0f,HalfLifeType.LONG, false).5,ItemCategory.CONTROL);
    public static final RegistryObject<Item> PELLET_RTG = registerWithCategory("pellet_rtg", () -> new ItemRTGPellet(10, new Item.Properties().stacksTo(1)).setDecays(DepletedRTGMaterial.LEAD, (
    long).

    getLifespan(87.7f,HalfLifeType.MEDIUM, false).5,ItemCategory.CONTROL);
    public static final RegistryObject<Item> PELLET_RTG_STRONTIUM = registerWithCategory("pellet_rtg_strontium", () -> new ItemRTGPellet(15, new Item.Properties()).setDecays(DepletedRTGMaterial.ZIRCONIUM, (
    long).

    getLifespan(29.0f,HalfLifeType.MEDIUM, false).5,ItemCategory.CONTROL);
    public static final RegistryObject<Item> PELLET_RTG_COBALT = registerWithCategory("pellet_rtg_cobalt", () -> new ItemRTGPellet(15, new Item.Properties()).setDecays(DepletedRTGMaterial.NICKEL, (
    long).

    getLifespan(5.3f,HalfLifeType.MEDIUM, false).5,ItemCategory.CONTROL);
    public static final RegistryObject<Item> PELLET_RTG_ACTINIUM = registerWithCategory("pellet_rtg_actinium", () -> new ItemRTGPellet(20, new Item.Properties()).setDecays(DepletedRTGMaterial.LEAD, (
    long).

    getLifespan(21.8f,HalfLifeType.MEDIUM, false).5,ItemCategory.CONTROL);
    public static final RegistryObject<Item> PELLET_RTG_AMERICIUM = registerWithCategory("pellet_rtg_americium", () -> new ItemRTGPellet(20, new Item.Properties().stacksTo(1)).setDecays(DepletedRTGMaterial.NEPTUNIUM, (
    long).

    getLifespan(4.7f,HalfLifeType.LONG, false).5,ItemCategory.CONTROL);
    public static final RegistryObject<Item> PELLET_RTG_POLONIUM = registerWithCategory("pellet_rtg_polonium", () -> new ItemRTGPellet(50, new Item.Properties().stacksTo(1)).setDecays(DepletedRTGMaterial.LEAD, (
    long).

    getLifespan(138.0f,HalfLifeType.SHORT, false).5,ItemCategory.CONTROL);
    public static final RegistryObject<Item> PELLET_RTG_GOLD = registerWithCategory("pellet_rtg_gold", () -> new ItemRTGPellet(VersatileConfig.rtgDecay(, new Item.Properties().stacksTo(1)).setDecays(DepletedRTGMaterial.MERCURY, (
    long).

    getLifespan(2.7f,HalfLifeType.SHORT, false).5,ItemCategory.CONTROL);
    public static final RegistryObject<Item> PELLET_RTG_LEAD = registerWithCategory("pellet_rtg_lead", () -> new ItemRTGPellet(VersatileConfig.rtgDecay(, new Item.Properties()).setDecays(DepletedRTGMaterial.BISMUTH, (
    long).

    getLifespan(0.3f,HalfLifeType.SHORT, false).5,ItemCategory.CONTROL);
