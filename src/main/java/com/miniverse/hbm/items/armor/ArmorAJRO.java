...
import com.miniverse.hbm.client.model.armor.ModelArmorAJRO;
...
public class ArmorAJRO extends ArmorFSBPowered {
    ...
    public ArmorAJRO(ArmorMaterial material, EquipmentSlot slot, String texture, long maxPower, long chargeRate, long consumption, long drain, Properties properties) {
    ...
    public void initializeClient(Consumer<IClientItemExtensions> consumer) {
        consumer.accept(new IClientItemExtensions() {
            ...
            public HumanoidModel<?> getHumanoidArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlot armorSlot, HumanoidModel<?> defaultModel) {
                ModelArmorAJRO model = ModelArmorAJRO.getModel(armorSlot);
